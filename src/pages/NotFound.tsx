  ...
  return (
    <div className="min-h-screen bg-[#F6F6F6] flex items-center justify-center" style={{ fontFamily: "Inter, sans-serif" }}>
      <div className="text-center px-4">
        <div className="w-20 h-20 bg-gradient-to-br from-[#0B2545] to-[#134074] rounded-2xl flex items-center justify-center mx-auto mb-6">
          <span className="text-white text-3xl font-bold">404</span>
        </div>
        <h1 className="text-3xl font-bold text-[#0B2545] mb-3">Siden ble ikke funnet</h1>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Button asChild variant="outline" className="rounded-lg border-[#134074] text-[#134074] hover:bg-[#E0F2FE] !bg-transparent">
